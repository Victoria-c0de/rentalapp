...
function ActualizarCliente(){
    ...
    const onSubmit = async (e) => {
        e.preventDefault();
        try {
            const clienteActualizado = { nombre, apellido, direccion, telefono, email};
        ...
        <div className="container">
            ...
            <form onSubmit={onSubmit}>
                <div className="form-group">
                    <label>RUT</label>
                    <input type="number" className="form-control" value={cliente_id} onChange={(e) => setClienteID(e.target.value)} disabled ></input>
                </div>
                <div className="form-group">
                    <label>NOMBRES</label>
